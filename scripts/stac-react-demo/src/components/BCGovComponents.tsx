...
const PageHeader: React.FC = () => {
  return (
    <div>
      <Header 
      title="SpatioTemporal Asset Catalog Demo"
      logoLinkElement={<a href="https://www2.gov.bc.ca/gov/content/data/about-data-management/geobc"></a>}
      logoImage={<img src="https://bcgov03.maps.arcgis.com/sharing/rest/content/items/44635c793f5c4f3497d2edcd69f9b954/data" 
      alt="GeoBC Logo" 
      style={{ height: "30px" }} />} 
      children={
        <a id="pantry-link" href="https://github.com/bcgov/gis-pantry" target="_blank">
